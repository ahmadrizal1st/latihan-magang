            ...
            <form id="formCreateCity" role="form">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select class="form-control select2-province" id="provinceId" name="province_id"
                            style="width: 100%;">
            ...
            <form id="formEditCity" role="form">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select class="form-control select2-province" id="editProvinceId" name="province_id"
                            style="width: 100%;">
                            <option value="">-- Select Province --</option>
                        </select>
                    </div>
