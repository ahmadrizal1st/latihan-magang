                ...
                <div class="box-header">
                    ...
                    <div class="box-tools pull-right">
                        <button type="button" class="btn btn-primary btn-sm" data-toggle="modal"
                            data-target="#modalCreateVillage">
            ...
            <form id="formCreateVillage" role="form">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select class="form-control select2-district" id="villageDistrictId" name="district_id"
                            style="width: 100%;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="villageName" name="name"
            ...
            <form id="formEditVillage" role="form">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select class="form-control select2-district" id="editVillageDistrictId" name="district_id"
                            style="width: 100%;">
                            <option value="">-- Select District --</option>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="editVillageName" name="name"
                            placeholder="Enter village name...">
                    </div>
                </div>
                <div class="modal-footer">
