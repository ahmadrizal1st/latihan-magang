                ...
                <form id="form-setting" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="mb-2">
                                    <img id="preview-logo" src="{{ asset('images/logo.png') }}" alt="Logo"
                                        class="img-thumbnail">
                                </div>
                        ...
                        {{-- Nama Perusahaan --}}
                        <div class="form-group">
                            <label class="col-sm-2 control-label text-left">Nama Perusahaan <span
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select name="company_province_id" class="form-control select2-province"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select name="company_city_id" class="form-control select2-city" style="width:100%"
                                    disabled></select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select name="company_district_id" class="form-control select2-district"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select name="company_village_id" class="form-control select2-village"
                                    style="width:100%" disabled></select>
